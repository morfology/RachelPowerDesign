...
---
import Accordion from '../../components/shortcodes/Accordion.astro';
import Button from '../../components/shortcodes/Button.astro';
import Notice from '../../components/shortcodes/Notice.astro';
...
![Sample image placeholder for interior design elements page](/images/image-placeholder.webp)
